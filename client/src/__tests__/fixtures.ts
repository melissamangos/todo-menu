...
export const TODO_LOW_AM = makeTodo({
  id: "1",
  name: "Stretch",
  energyCost: "low",
  timeslot: "am",
...
export const TODO_LOW_PM = makeTodo({
  id: "2",
  name: "Read",
  energyCost: "low",
  timeslot: "pm",
...
export const TODO_MED_AM = makeTodo({
  id: "3",
  name: "Cook lunch",
  energyCost: "medium",
  timeslot: "am",
...
export const TODO_MED_EVE = makeTodo({
  id: "4",
  name: "Call friend",
  energyCost: "medium",
  timeslot: "eve",
...
export const TODO_HIGH_PM = makeTodo({
  id: "5",
  name: "Run 5k",
  energyCost: "high",
  timeslot: "pm",
  boons: ["physical activity"],
});
export const TODO_HIGH_EVE = makeTodo({
  id: "6",
  name: "Therapy notes",
  energyCost: "high",
  timeslot: "eve",
